...
if(empty($_POST['naslov']) || empty($_POST['sadrzaj']) || empty($_POST['komentar_id']))
{
...
$id = Komentar::izmeni_komentar($_POST['naslov'],$_POST['sadrzaj'],$_SESSION['korisnik_id'],$_POST['komentar_id']);
if($id > 0) {
    //header('Location: ../prijavljen.php');
    //die();
